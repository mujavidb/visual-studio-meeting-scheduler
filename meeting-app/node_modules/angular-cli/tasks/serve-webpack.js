...
exports.default = Task.extend({
    run: function (serveTaskOptions) {
        ...
        var config = new webpack_config_1.NgCliWebpackConfig(this.project, serveTaskOptions.target, serveTaskOptions.environment, undefined, undefined, serveTaskOptions.i18nFile, serveTaskOptions.i18nFormat, serveTaskOptions.locale, serveTaskOptions.aot, serveTaskOptions.sourcemap, serveTaskOptions.vendorChunk, serveTaskOptions.verbose, serveTaskOptions.progress, undefined, undefined, serveTaskOptions.extractCss).config;
        ...
        (_c = config.entry.main).unshift.apply(_c, entryPoints);
